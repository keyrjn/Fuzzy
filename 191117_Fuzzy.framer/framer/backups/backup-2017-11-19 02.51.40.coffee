...
H_slider.draggable.enabled = true
V_slider.draggable.enabled = true
V_slider.draggable.speedX = 0
H_slider.draggable.speedY = 0

H_slider.opacity=0

V_slider.onDragEnd (event, layer) ->
...
# 	errorText.html = b
	...
	opacityVal= Utils.modulate(Math.abs(b),[0,50],[0,1])
